...
helm install pihole oci://ghcr.io/nunoferna/charts/pihole --version 0.1.3
```
...
- **Chart Version**: Version of the Helm chart itself (e.g., `0.1.3`)
...
helm pull pihole-helm/pihole --version 0.1.3
helm verify pihole-0.1.3.tgz
```
