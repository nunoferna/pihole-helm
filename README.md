...
helm install pihole oci://ghcr.io/nunoferna/charts/pihole --version 0.2.6
```
...
- **Chart Version**: Version of the Helm chart itself (e.g., `0.2.6`)
...
helm pull pihole-helm/pihole --version 0.2.6
helm verify pihole-0.2.6.tgz
```
